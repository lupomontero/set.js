...
function Set(iterable) {
  ...
  if (iterable) {
    [].forEach.call(iterable, function (item) {
      _this.add(item);
    });
  }
}
...
Set.prototype[Symbol.iterator] = function () {
  ...
  return {
    next: function next() {
      return nextIndex < _this2.data.length ? { value: _this2.data[nextIndex++], done: false } : { done: true };
    }
  };
};
...
},{"d3-color":3,"d3-dispatch":4,"d3-ease":5,"d3-interpolate":6,"d3-selection":7,"d3-timer":8}],10:[function(require,module,exports){
...
},{"d3-selection":7,"d3-transition":9}]},{},[1]);
